  ...
  return (
    <>
      <div className="my-6 flex gap-4">
        <Link
          to={"/"}
          className="flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-border bg-background/60 px-4 text-center text-foreground transition-colors hover:bg-accent hover:text-accent-foreground dark:border-white/10 dark:bg-white/2 dark:text-slate-200 dark:hover:bg-white/6 dark:hover:text-white"
        >
